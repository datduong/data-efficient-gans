...
batchsize=8 #128
arch_size=96 
rootname=/data/duongdb/NF1BeforeAfter01122021/Crop/
...
--test_every 20 --save_every 20 --num_best_copies 4 --num_save_copies 2 --seed 0 \
--use_multiepoch_sampler \
--pretrain /data/duongdb/BigGAN-PyTorch/100k \
--experiment_name DiffAugment-cr-Nf125img \
--DiffAugment cutout --CR 10 --mirror_augment \
--which_best FID \
--num_inception_images 45 \
--z_var variance \
--z_var_scaler 10 \
